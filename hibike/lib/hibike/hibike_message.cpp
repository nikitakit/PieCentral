...
int send_heart_beat_response(uint8_t id){ //id = for future heartbeat identification
  message_t msg;
...
int send_heart_beat_request(uint8_t id){ //id = future hearbeat identification
  message_t msg;
